...
- Git is available only in images built with `IGNIS_INCLUDE_GIT=true`; child processes now have session ownership, disconnect cleanup, timeout escalation, and configurable concurrency limits.
